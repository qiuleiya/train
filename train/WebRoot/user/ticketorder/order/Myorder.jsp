...
<div class="container">
    <div class="row clearfix biaoti1">
 		<h1><img src="image/glyjm.jpg" class="img-circle"width="50"height="50"/>我的订单</h1>
	</div>
        <div class="row clearfix" >
            ...
            <%String username= request.getParameter("username");   //获取url中的参数值%>
                <sql:setDataSource var="snapshot" driver="com.microsoft.sqlserver.jdbc.SQLServerDriver"
                  ...
                  <c:set var="empId" value="<%=username%>"/>
               ...
               <!-- 输出我的订单-->
                ...
                <table border="1">
                 ...
                 <form action="user/ticketorder/retrun/doreturn.jsp" method="post">
                 <input type="hidden" name='username' id='username' value="<%=username%>" >
                   
                               <select name="oder_num" id="oder_num">
                                <c:forEach var="row" items="${result.rows}">
                                  <option value="${row.oder_num}">${row.oder_num}</option>
                                  </c:forEach>
                                  </select>
